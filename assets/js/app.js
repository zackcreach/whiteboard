...
const hooks = { ...colocatedHooks, ExerciseReorder, FlashAutoDismiss, ProgressionChart, ThemeSwitcher }
...
topbar.config({ barColors: { 0: 'var(--primary-color)' }, shadowColor: 'rgba(0, 0, 0, .3)' })
